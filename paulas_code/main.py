...
def add_arguments():
    ...
    parser.add_argument("--dataset", default="aerosol_2", help="choose a data set to use")
    parser.add_argument("--model", default="cnn")
    parser.add_argument("--model_id", default="test_cnn_add_newdata_aerosol")
    parser.add_argument("--upsampling_factor", default=10, type=int)
    parser.add_argument("--constraints", default="add") 
